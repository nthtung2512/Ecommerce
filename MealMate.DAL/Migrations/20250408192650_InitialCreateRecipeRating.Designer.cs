...
namespace MealMate.DAL.Migrations
{
    ...
    [Migration("20250408192650_InitialCreateRecipeRating")]
    partial class InitialCreateRecipeRating
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MealMate.DAL.Entities.Chatbot.Ingredient", b =>
                {
                    ...
                    b.HasKey("RecipeId", "Name");

                    b.ToTable("ingredient", (string)null);
                });

            modelBuilder.Entity("MealMate.DAL.Entities.Chatbot.Recipe", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MealMate.DAL.Entities.Chatbot.RecipeRating", b =>
                {
            ...
            modelBuilder.Entity("MealMate.DAL.Entities.Chatbot.Ingredient", b =>
                {
                    b.HasOne("MealMate.DAL.Entities.Chatbot.Recipe", "Recipe")
            ...
            modelBuilder.Entity("MealMate.DAL.Entities.Chatbot.RecipeRating", b =>
                {
                    b.HasOne("MealMate.DAL.Entities.ApplicationUser.Customer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MealMate.DAL.Entities.Chatbot.Recipe", null)
                        .WithMany()
                        .HasForeignKey("RecipeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
